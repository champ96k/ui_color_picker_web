...
class SimpleColor extends StatefulWidget {
  @override
  _SimpleColorState createState() => _SimpleColorState();
}

class _SimpleColorState extends State<SimpleColor> {
  int selectedIndex;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: FutureBuilder(
        future: APIServices().simpleColor(),
